...
setAbbreviations = function (abbr) {
    ...
    } else { abbreviations = englishAbbreviations; }
}
...
function getText() {
    ...
    f = fso.OpenTextFile(fso.GetParentFolderName(WScript.ScriptFullName) + "\\content.txt", ForReading);
    return (f.ReadAll());
}
...
function createSummary(summary) {
    var fso, f;
    fso = new ActiveXObject("Scripting.FileSystemObject");
    f = fso.CreateTextFile(fso.GetParentFolderName(WScript.ScriptFullName) + "\\summary.txt", true);
    f.WriteLine(summary);
    f.Close();
